...
# Parsing + Configuration Script – RUT240 - Rev. A

This **Parsing + Configuration** script is designed for the **RUT240** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – RUT240 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **RUT240** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
